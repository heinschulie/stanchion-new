...
function zerif_customize_register( $wp_customize ) {
  ...
  /**********	OUR JOB SECTION ***************/
	/******************************************/
	$wp_customize->add_section( 'zerif_ourjob_section' , array(
			'title'       => __( 'Our job section', 'zerif-lite' ),
    	  	'priority'    => 36,
			
			'description' => __( 'The main content of this section is customizable in: Customize -> Widgets -> Our job section. There you must add the "Zerif - Job member widget"', 'zerif-lite' )
	));
	/* our job show/hide */
	$wp_customize->add_setting( 'zerif_ourjob_show', array('sanitize_callback' => 'zerif_sanitize_text'));
    $wp_customize->add_control(
		'zerif_ourjob_show',
		array(
			'type' => 'checkbox',
			'label' => __('Hide our job section?','zerif-lite'),
			'section' => 'zerif_ourjob_section',
			'priority'    => 1,
		)
	);
	/* our job title */
	$wp_customize->add_setting( 'zerif_ourjob_title', array('sanitize_callback' => 'zerif_sanitize_text','default' => __('YOUR JOBS','zerif-lite')));
	$wp_customize->add_control( 'zerif_ourjob_title', array(
				'label'    => __( 'Title', 'zerif-lite' ),
				'section'  => 'zerif_ourjob_section',
				'settings' => 'zerif_ourjob_title',
				'priority'    => 2,
	));
	/* our job subtitle */
	$wp_customize->add_setting( 'zerif_ourjob_subtitle', array('sanitize_callback' => 'zerif_sanitize_text','default' => __('Prove that you have real positions and jobs available.','zerif-lite')));
	$wp_customize->add_control( 'zerif_ourjob_subtitle', array(
			'label'    => __( 'Our job subtitle', 'zerif-lite' ),
	      	'section'  => 'zerif_ourjob_section',
	      	'settings' => 'zerif_ourjob_subtitle',
			'priority'    => 3,
	));
