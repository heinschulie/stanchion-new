...
/**
 * stanchion functions and definitions
 *
 * @package stanchion!
 */
...
function zerif_widgets_init()
{
    ...
    register_sidebar(array(
        ...
        'name' => __('Our jobs section', 'zerif-lite'),
    ...
    register_sidebar(array(
        ...
        'name' => __('Job details section', 'zerif-lite'),

        'id' => 'sidebar-jobdetail',
    ...
    register_sidebar(array(
        ...
        'name' => __('Product details section', 'zerif-lite'),

        'id' => 'sidebar-productdetail',
...
/* register_widget('zerif_testimonial_widget'); */
    ...
    register_widget('zerif_job_widget');
...
class zerif_team_widget extends WP_Widget
{
    ...
    function widget($args, $instance)
    {
        ...
        <div class="col-lg-4 col-sm-3 team-box">
            ...
            <div class="team-member">
                ...
                <div class="member-details">
					...
					<?php if( !empty($instance['name']) ): ?>
						...
						<h5 class="dark-text orange-border-bottom"><?php echo apply_filters('widget_title', $instance['name']); ?></h5>
...
add_action('customize_controls_print_scripts', 'zerif_job_widget_scripts');

function zerif_job_widget_scripts()
{
    wp_enqueue_media();

    wp_enqueue_script('zerif_job_widget_script', get_template_directory_uri() . '/js/widget-job.js', false, '1.0', true);
}


class zerif_job_widget extends WP_Widget
{

    function zerif_job_widget()
    {

        $widget_ops = array('classname' => 'zerif_job');

        $this->WP_Widget('zerif_job-widget', 'Zerif - Job member widget', $widget_ops);
    ...
    <div class="col-lg-2 col-sm-3 job-box">
      <div class="job-member">

        <div class="member-details">
          <?php if( !empty($instance['position']) ): ?>
          <div class="position">
            <?php echo htmlspecialchars_decode(apply_filters('widget_title', $instance['position'])); ?>
          </div>
          <?php endif; ?>
        </div>
    ...
    <?php
        ...
        function form($instance)
        {
          ...
          <p>
            <label for=""
              <?php echo $this->get_field_id('position'); ?>"><?php _e('Position', 'zerif-lite'); ?>
            </label>
            <br/>

            <textarea class="widefat" rows="8" cols="20" name=""
              <?php echo $this->get_field_name('position'); ?>"
              id="<?php echo $this->get_field_id('position'); ?>"><?php
                          if( !empty($instance['position']) ): echo htmlspecialchars_decode($instance['position']); endif;
                      ?>
            </textarea>
          ...
          <p>
            <label
                for=""
              <?php echo $this->get_field_id('description'); ?>"><?php _e('Description', 'zerif-lite'); ?>
            </label>
            <br/>

            <textarea class="widefat" rows="8" cols="20" name=""
              <?php echo $this->get_field_name('description'); ?>"
              id="<?php echo $this->get_field_id('description'); ?>">
              <?php if( !empty($instance['description']) ): echo htmlspecialchars_decode($instance['description']); endif;?>
            </textarea>
...
function zerif_excerpt_more( $more ) {
	return '<a href="'.get_permalink().'"> ...<p style="text-decoration: underline">Read More</p></a>';
}
...
/* CUSTOM STANCHION CODE TO SHORTEN THE EXCERPT LENGTH */
