...
/* Start Adding Functions Below this Line */
	...
	class job_widget extends WP_Widget
	{
      ...
      <p>
        <label for="<?php echo $this->get_field_id( 'functions' ); ?>"><?php _e( 'Functions:' ); ?></label>
        <input class="widefat" id="<?php echo $this->get_field_id( 'functions' ); ?>" name="<?php echo $this->get_field_name( 'functions' ); ?>" type="text" value="<?php echo esc_attr( $functions ); ?>" />
      </p>
			<p>
